...
export class AppComponent implements OnInit {
  ...
  userSearch(value: any) {
    ...
    if (value === this.cardObjects.filter(a => a.fullName.includes(value.toLowerCase()))) {
      console.log(value);
      this.cardObjects = this.cardObjects.filter(a => a.fullName.includes(value.toLowerCase()));
    } else {
