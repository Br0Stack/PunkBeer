...
export class AppComponent implements OnInit {
  ...
  userSearch(value: any) {
    //console.log('cardobjects: ' + this.cardObjects + 'searchObjects: ' + this.searchObjects)
    if (this.cardObjects.filter(a => a.fullName.includes(value.toLowerCase())) == true) {
      console.log(value);
      const newCardObjects = this.cardObjects.filter(a => a.fullName.includes(value.toLowerCase()));
